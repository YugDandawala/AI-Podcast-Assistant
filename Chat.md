...
**👤 Human:** suggest me ome project where i can use this core llm techniques and this new Genai tech together which can make my profile better then everyone
...
**👤 Human:** if i want o make a AI agent that continously have access to my screen and see everythning that i do and when i ask some question it will give me proper guideline becuase it has seen my screen and evrything
...
**👤 Human:** if i build this product is this a very new and more important tools for AIML engineers to use which can help to know about the feature importance ,about the data,which algorith should i use evrything and can it be considered as world level startup which can be funded very well and
...
> “Your target is correlated with timestamp → possible leakage.”
> “Class 3 has only 19 samples → any insight is unreliable.”
> “Two feaures encode the label directly.”
> “These 4 columns are probably identifier for giving this type of question i will need an another agent who can read the whole dataset and give insights but i cant provide a agent that can do the changes in datasets as it wants as the data could be confidential of user andit cantbe changed

---

**👤 Human:** but i will need a better solution then this for very bad data
...
**👤 Human:** so basically ill need 5- 6 agents in my system
...
**👤 Human:** 🗺 system architecture diagram 🧬 internal scoring framework 🧪 research checklist for each agent provide me all this 3 things
...
**👤 Human:** this is a very hard system to build i think and i am the only one to build it letsassume i will work 3 hour average a day to build this how much time it will take it to build
